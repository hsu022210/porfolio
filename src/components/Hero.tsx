...
const Hero = () => {
  const heroAnimation = useScrollAnimation({ staggerDelay: 0.2 });
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative bg-background">
      ...
      <motion.div 
        className="container relative z-10 flex flex-col items-center text-center gap-4 sm:gap-6 py-16 sm:py-24 px-4"
        ref={heroAnimation.ref}
        variants={heroAnimation.containerVariants}
        initial="hidden"
        animate="visible"
      >
        <motion.div variants={heroAnimation.itemVariants}>
        ...
        <motion.h1 variants={heroAnimation.itemVariants} className="text-3xl sm:text-4xl md:text-5xl font-bold mb-2 crisp-text px-2">
        ...
        <motion.p variants={heroAnimation.itemVariants} className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed mb-4 crisp-text px-4">
        ...
        <motion.div variants={heroAnimation.itemVariants} className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-4 w-full max-w-sm sm:max-w-none">
        ...
        <motion.div variants={heroAnimation.itemVariants} className="flex justify-center items-center gap-4 sm:gap-6 mb-6 sm:mb-8">
